...
--
-- Table structure for table `optibreed_condition`
--

CREATE TABLE `optibreed_condition` (
  `id` bigint(20) NOT NULL,
...
--
-- Table structure for table `optibreed_room`
--
...
--
-- Indexes for table `optibreed_condition`
--
ALTER TABLE `optibreed_condition`
  ADD PRIMARY KEY (`id`),
  ADD KEY `optibreed_condition_Room_id_2cf7c302_fk_optibreed_room_id` (`Room_id`);

--
-- Indexes for table `optibreed_room`
--
ALTER TABLE `optibreed_room`
  ADD PRIMARY KEY (`id`),
  ADD KEY `optibreed_room_User_id_3ada329f_fk_auth_user_id` (`User_id`);
...
--
-- AUTO_INCREMENT for table `optibreed_condition`
--
ALTER TABLE `optibreed_condition`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `optibreed_room`
--
ALTER TABLE `optibreed_room`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `optibreed_condition`
--
ALTER TABLE `optibreed_condition`
  ADD CONSTRAINT `optibreed_condition_Room_id_2cf7c302_fk_optibreed_room_id` FOREIGN KEY (`Room_id`) REFERENCES `optibreed_room` (`id`);

--
-- Constraints for table `optibreed_room`
--
ALTER TABLE `optibreed_room`
  ADD CONSTRAINT `optibreed_room_User_id_3ada329f_fk_auth_user_id` FOREIGN KEY (`User_id`) REFERENCES `auth_user` (`id`);
COMMIT;
